...
<!-- Link file css nhờ mapping bên minishop-servlet -->
<title>Insert title here</title>
<jsp:include page="header.jsp"></jsp:include>
</head>
<body>

	<%-- <h2>${tendangnhap}</h2> <!-- Cách thứ 1 để lấy giá trị từ controller trả về -->
	<h2><%=(String)request.getAttribute("tendangnhap") %></h2> <!-- Cách thứ 2 để lấy giá trị từ controller trả về -->
	<h2>${pass}</h2>
	<h2>${nhanvien.getTenNhanVien()}</h2>
	<h2>${nhanvien.getDiaChi()}</h2>
	
	<h1><a href="chitiet/22/tandung">Trang chi tiết</a></h1>
	...
	<%-- 	<h1>${hoten}</h1> --%>
	<!-- <form action="chitiet" method="post">
		<input type="text" name="tenNhanVien"><br> <input
			type="text" name="diaChi"><br> <input type="text"
			name="tuoi"><br> <input type="submit"
			value="Post Du Lieu">
	</form> -->
	<%-- <h1>Tên bằng jstl: <c:out value="${ten}"></c:out></h1>
	<h1>Tuổi bằng jstl: <c:out value="${tuoi}"></c:out></h1> --%>
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"> <img alt=""
						src='<c:url value="/resources/image/fall_leaf.png"/>'>
					</a>
				</div>
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-center">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							aria-expanded="false">Sản phẩm <span class="caret"></span>
						</a>
							<ul class="dropdown-menu">
								<c:forEach var="value" items=" ${ danhMucs }">
									<li><a href="san-pham/${value }"> ${value} </a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						<c:choose>
							<c:when test="${chucaidau != null}">
								<li><a href="dangnhap/" class="circle-avatar"> <span>${chucaidau}</span>
								</a></li>
							</c:when>
							<c:otherwise>
								<li><a href="dangnhap/"> <span>ĐĂNG NHẬP</span>
								</a></li>
							</c:otherwise>
						</c:choose>
						<li><a href="#"> <img alt=""
	...
	<div id="info" class="container">
		<div class="row">
			<div class="col-12 col-md-4 col-sm-4 wow fadeInLeft"
				...
				<br /> <span>Chúng tôi cam kết mang đến cho các bạn chất
					lượng sản phẩm tốt nhất</span> <br />
			</div>
					...
					<a href="chitiet/${ sanpham.getId() }">
						<div class="sanpham wow zoomIn">
							...
							<br /> <span>${sanpham.getTenSanPham() }</span> <br /> <span
								class="gia">${sanpham.getGiaTien() } VND</span>
						</div>
					</a>
				</div>
			</c:forEach>
	...
	<div id="footer" class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-4 col-md-4 wow tada">
				...
				<span>Xuân La, Tây Hồ, Hà Nội</span> <br /> <span>anhtu7696@gmail.com</span>
				<br /> <span>0974858669</span> <br />
			</div>
			<div class="col-sm-4 col-md-4 wow tada">
				<p>
